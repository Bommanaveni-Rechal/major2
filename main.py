...
class window1(QtWidgets.QMainWindow, medlai1.Ui_MainWindow):
...
class window2(QtWidgets.QMainWindow, medlai2.Ui_MainWindow):
    def __init__(self, *args, **kwargs):
        QtWidgets.QMainWindow.__init__(self, *args, **kwargs)
        self.setupUi(self)
...
class window3(QtWidgets.QMainWindow, medlai3.Ui_MainWindow):
    def __init__(self, *args, **kwargs):
        QtWidgets.QMainWindow.__init__(self, *args, **kwargs)
        self.setupUi(self)
